...
data = dict(
    ...
    train=dict(
        ...
        sup=dict(
            type="DOTADataset",
            ann_file="data/dota1.5/train_obb/split_images/annfiles/",
            img_prefix="data/dota1.5/train_obb/split_images/images/",
            pipeline=train_pipeline,
        ),
        unsup=dict(
            type="DOTADataset",
            ann_file="data/dota1.5/test_obb/split_images/annfiles/",
            img_prefix="data/dota1.5/test_obb/split_images/images/",
