_base_ = ["../../thirdparty/mmrotate/configs/rotated_faster_rcnn/rotated_faster_rcnn_r50_fpn_for_s3od_teacher_soda.py",
          "../../thirdparty/mmrotate/configs/rotated_faster_rcnn/rotated_faster_rcnn_r50_fpn_for_s3od_student_soda.py"]
...
data = dict(
    ...
    train=dict(
        ...
        sup=dict(
            type="SODADataset",
            ann_file="data/soda/train_obb/annfiles/",
            img_prefix="data/soda/train_obb/images/",
            pipeline=train_pipeline,
        ),
        unsup=dict(
            type="SODADataset",
            ann_file="data/soda/test_obb/annfiles/",
            img_prefix="data/soda/test_obb/images/",
            pipeline=unsup_pipeline,
            filter_empty_gt=False,
        ),
    ),
    val=dict(
        ann_file='data/soda/val_obb/annfiles/',
        img_prefix='data/soda/val_obb/images/',
...
evaluation = dict(type="SubModulesDistEvalHook", interval=100*100, save_best='auto')
optimizer = dict(type="SGD", lr=0.001, momentum=0.9, weight_decay=0.0001)
lr_config = dict(step=[1000*280, 1000*300])
runner = dict(_delete_=True, type="IterBasedRunner", max_iters=(320000))
checkpoint_config = dict(by_epoch=False, interval=100*100, max_keep_ckpts=2)
