...
data = dict(
    ...
    train=dict(
        ...
        sup=dict(
            type="SODADataset",
            ann_file="data/soda/semi_train/semi-${fold}@${percent}/labels/",
            img_prefix="data/soda/train_obb/images/",
            pipeline=train_pipeline,
        ),
        unsup=dict(
            type="SODADataset",
            ann_file='data/soda/semi_train/semi-${fold}@${percent}-unlabeled/labels/',
            img_prefix='data/soda/train_obb/images/',
...
lr_config = dict(step=[1000*100, 1000*110])
