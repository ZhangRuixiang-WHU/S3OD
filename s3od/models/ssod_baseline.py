### This is the implementation of SSOD_baseline in the paper, based on the Soft-Teacher Code framework (https://github.com/ microsoft/SoftTeacher) 
### We removing the processing of "soft teacher" and "box jittering" in Soft-Teacher
### The functions of "unsup_rcnn_cls_loss" and "unsup_rcnn_reg_loss" in soft_teacher.py are change to "unsup_rcnn_loss"
