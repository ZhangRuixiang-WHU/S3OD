...
if __name__ == "__main__":
    ...
    for imageset in imagesets:
        ...
        annopath = '/data/zrx/{}/{}/split_images/annfiles_5p'.format(core_dataset, imageset)
        ...
        with open(os.path.join(save_path, "dotav2_{}_5p.json".format(imageset)), "w") as jsonfile:
