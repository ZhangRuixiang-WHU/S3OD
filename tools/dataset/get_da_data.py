...
# ref_txt = open('/data/zrx/Rotated/DOTA-v2/DOTA_V2_train_GF.txt', encoding='utf-8')
# ref_data = ref_txt.readlines()
# ref_name = []
# for d in ref_data:
#     ref_name.append(d.split('\n')[0])

# DA_dotav2_dir = '/data/zrx/Rotated/SSDA_dotav2'
...
# ref_txt = open('/data/zrx/Rotated/DOTA-v2/DOTA_V2_val_GF.txt', encoding='utf-8')
# ref_data = ref_txt.readlines()
# ref_name = []
# for d in ref_data:
#     ref_name.append(d.split('\n')[0])
...
ref_txt = open('/data/zrx/Rotated/DOTA-v2/DOTA_V2_test_GF.txt', encoding='utf-8')
ref_data = ref_txt.readlines()
ref_name = []
for d in ref_data:
    ref_name.append(d.split('\n')[0])
