...
if __name__ == "__main__":
    ...
    voc_class = {'ship': 1, 'destroyer': 2, 'amphibious': 3, 'cruiser': 4, 'submarine': 5, 'frigate': 6, 'aircraft-carrier': 7}
    coco_class = [{'supercategory': 'none', 'id': 1,   'name': 'ship',                 },
                  {'supercategory': 'none', 'id': 2,   'name': 'destroyer',            },
                  {'supercategory': 'none', 'id': 3,   'name': 'amphibious',           },
                  {'supercategory': 'none', 'id': 4,   'name': 'cruiser'               },
                  {'supercategory': 'none', 'id': 5,   'name': 'submarine',            },
                  {'supercategory': 'none', 'id': 6,   'name': 'frigate',              },
                  {'supercategory': 'none', 'id': 7,   'name': 'aircraft-carrier',     }]

    imagesets = ['source_train','source_val','target_train','target_val']#
    core_dataset = 'Rotated/SSDA_ship'
    groundtruth = True
    # release_version = 'v1'
    ...
    for imageset in imagesets:
        ...
        with open(os.path.join(save_path, "ssda_ship_{}.json".format(imageset)), "w") as jsonfile:
