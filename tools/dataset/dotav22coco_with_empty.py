...
if __name__ == "__main__":
    ...
    imagesets = ['train_obb','val_obb',]#
    core_dataset = 'Rotated/DOTA-v2'
    groundtruth = True
    # release_version = 'v1'
    ...
    for imageset in imagesets:
        ...
        annopath = '/data/zrx/{}/{}/split_images/annfiles_rm_90'.format(core_dataset, imageset)
        ...
        with open(os.path.join(save_path, "dotav2_{}_rm_90_all.json".format(imageset)), "w") as jsonfile:
