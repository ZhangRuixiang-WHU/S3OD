...
def prepare_coco_data(seed=1, percent=10.0, version=2017, seed_offset=0):
    ...
    image_dir = '/home/zrx/ssod/SoftTeacher/data/soda/train_obb/images'
    label_dir = '/home/zrx/ssod/SoftTeacher/data/soda/train_obb/annfiles'
    labeled_save_path = '/home/zrx/ssod/SoftTeacher/data/soda/semi_train/semi-{}@{}'.format(str(int(seed)),str(int(percent)))
    unlabeled_save_path = '/home/zrx/ssod/SoftTeacher/data/soda/semi_train/semi-{}@{}-unlabeled'.format(str(int(seed)),str(int(percent)))
    ...
    for i in range(len(image_list)):
        if i in labeled_ind:
            labeled_images.append(image_list[i].split('.jpg')[0])
        else:
            unlabeled_images.append(image_list[i].split('.jpg')[0])
